from .config import (
    ADMINISTRATIVE_CENTER_ICON_ASSET_NAME,
    ASSETS_DIR,
    BUSINESS_AREA_ICON_ASSET_NAME,
    G_LAT,
    G_LON,
    HISTORICAL_ICON_ASSET_NAME,
    INTERACTIVE_DIR,
...
def write_yerevan_single_polygon_html(
    ...
    #
    # Output:
    #   data/build/site/yerevan_interactive_model.html
    #
    ...
    def payload_for_browser(payload: dict) -> dict:
        return {
            ...
            "assets": {
                "historical_icon": f"assets/{HISTORICAL_ICON_ASSET_NAME}",
                "business_area_icon": f"assets/{BUSINESS_AREA_ICON_ASSET_NAME}",
                "administrative_icon": f"assets/{ADMINISTRATIVE_CENTER_ICON_ASSET_NAME}",
            },
        }
    ...
    <body>
      ...
      <script>
        ...
        const histIconUrl = (data.assets && data.assets.historical_icon)
          ...
          : "assets/historical_center_icon.png";
    ...
    html_path = os.path.join(OUT_DIR, INTERACTIVE_MODEL_HTML_NAME)
